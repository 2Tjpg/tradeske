...
export function ConfigurableDigitsControls(props: ConfigurableDigitsControlsProps) {
  ...
  const renderTradeType = () => {
    const variants: Record<StyleVariant, () => React.ReactNode> = {
      ...
      a: () => (
        <div className="-mx-3 overflow-x-auto px-3 pb-0.5 scroll-px-3 [-webkit-overflow-scrolling:touch] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden sm:mx-0 sm:px-0 sm:scroll-px-0">
          <TradeTypeChips
            value={tradeType}
